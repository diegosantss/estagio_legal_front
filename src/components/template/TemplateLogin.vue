<template>
  ...
  <div class="input_container">
    ...
    <input placeholder="example@example.com" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
  ...
  <button title="Sign In" type="submit" class="sign-in_btn" @click="login">
    <span>Entrar</span>
  </button>
